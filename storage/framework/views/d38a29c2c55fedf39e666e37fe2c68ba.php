...
<body class="d-flex flex-column align-items-center bg-light vh-100">
    ...
    <div class="navbar-custom w-75">
        ...
        <a href="<?php echo e(route('layout.register')); ?>" class="active">Đăng ký</a>
    </div>

    <!-- Form đăng ký -->
    <div class="container-custom mt-3">
        <h3 class="text-center">Màn hình đăng ký</h3>
        <form action="<?php echo e(route('layout.postRegister')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    ...
    <div class="d-flex justify-content-between align-items-center">
        <a href="<?php echo e(route('layout.login')); ?>" class="text-decoration-none">Đã có tài khoản?</a>
...
<?php /**PATH D:\laptrinhbe2.git\resources\views/layout/register.blade.php ENDPATH**/ ?>